                            ...
                            <div class="col-md-8">
                                <div class="form-group has-icon-left">
                                    <div class="position-relative">
                                        <input type="text" class="form-control" placeholder="ID Barang" id="first-name-icon" value="<?php echo $idbarang ?>" readonly name="id_barang">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="function/proses_user.php?aksi=delete&id_barang=<?php echo $d['id_barang'] ?>" class='badge bg-danger text-decoration-none'>
